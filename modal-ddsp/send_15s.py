#!/usr/bin/env python3
"""Send 15-second audio clip to Modal DDSP."""

import modal
from modal_app import app, timbre_transfer

# Read the 15s clip
with open("433_clip_15s.wav", "rb") as f:
    audio_data = f.read()

print(f"Sending {len(audio_data)} bytes (15s audio at 16kHz) to Modal DDSP...")
...
with app.run():
    ...
    if result["status"] == "success":
        ...
        # Save output
        output_path = "433_clip_15s_violin.wav"
